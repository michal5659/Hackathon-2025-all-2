...
If Classified, Generate the Following JSON (and ONLY this JSON):
{
  "queueId": 10886,
  "contactExtId": "string",
  "dueOn": "2025-11-06T12:09:35.827Z",
  "updateVersion": 0,
  "taskDescription": "Contact: [contact reference]",
  "priority": 1,
  "accountExtName": "string",
  "claimExtNumber": "string",
  "installmentId": 0,
  "followUpSuperType": 10000,
  "startHandlingOn": "2025-11-06",
  "consequences": 0,
  "id": 0,
  "policyExtNumber": "string",
  "remarks": "string",
  "taskCategory": 0
}
...
"""
    ...
    def _build_valid_user_msg(self) -> str:
        return """"
        {
          ...
          "subject": "Change of address for Contact ID: 11223",
          "body": "Hello,\n\nPlease update the contact information for Contact ID: 11223. The new address is 45 Herzl Street, Tel Aviv, 67890.\n\nThank you,\nNoa"
        }
         """
